...
#define BIAS_FUNC(m_var, m_idx)                                                                 \
	...
	m_var.xyz += normal_bias;
				...
				if (sc_use_directional_soft_shadows && directional_lights.data[i].softshadow_angle > 0) {
					...
					shadow = sample_directional_pcf_shadow(directional_shadow_atlas, directional_shadow_pixel_size * directional_lights.data[i].soft_shadow_scale * (blur_factor + (1.0 - blur_factor) * float(directional_lights.data[i].blend_splits)), pssm_coord);
					...
					if (directional_lights.data[i].blend_splits) {
						...
						float shadow2 = sample_directional_pcf_shadow(directional_shadow_atlas, directional_shadow_pixel_size * directional_lights.data[i].soft_shadow_scale * (blur_factor2 + (1.0 - blur_factor2) * float(directional_lights.data[i].blend_splits)), pssm_coord);
